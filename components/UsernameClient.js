...
const UsernameClient = ({ username }) => {
    ...
    const fillData = async () => {
        ...
        setDynaData({ username: data.user.username, profilepic: data.user.profilepic, coverpic: data.user.coverpic })
            ...
            <div className='text-white'>
                ...
                <div className="relative p-5 mb-3 flex flex-col gap-4 items-center">
                    ...
                    <div className="info pt-20 gap-4 flex flex-col justify-center items-center">
                        ...
                        <div className='text-lg text-neutral-200 '>{supporters} members &middot; ₹{totaAmount} raised</div>
                    </div>
                </div>
