  ...
  return (
    <div className="text-white">
      <div className=" hero relative bg-[url('/hero-bg.jpg')] bg-cover bg-center min-h-screen ">
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="relative z-10 flex flex-col items-center pt-60 pb-20  ">
          ...
          <div className="buttons grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="stats grid grid-cols-1 md:grid-cols-3 gap-10 mt-8">
      ...
      <div className="trending flex flex-col items-center py-24 px-6 w-full max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {creators.length === 0 ? (
            ...
            return (<motion.div key={item._id} initial={{opacity:0,y:50}} whileInView={{opacity:1,y:0}} viewport={{once:true}} transition={{duration: 0.4, delay:index*0.1}}>
      ...
      <motion.div initial={{opacity:0,y:70}} whileInView={{opacity:1,y:0}} transition={{duration:0.7}} className="why flex flex-col md:flex-row md:justify-between justify-center items-center gap-16 py-32 px-6 max-w-6xl mx-auto">
        <div className="flex-1 relative w-full flex justify-center md:justify-start">
          <div className="absolute md:top-4 md:-left-4 w-full max-w-xs h-full bg-neutral-800 rounded-3xl z-0 border border-white/5"></div>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-20 py-20 px-3 max-w-5xl mx-auto">
        ...
        <div className=" flex-1 w-full flex justify-center">
          <div className="card bg-neutral-900/70 backdrop-blur-md border border-white/10 p-6 rounded-xl shadow-2xl w-full max-w-sm ">
            ...
            <Link className="w-full block text-center font-bold text-md py-2 px-4 rounded-lg bg-violet-600 hover:bg-violet-700 transition-colors mt-4" href={'/creators'}>Support</Link>
          </div>
        </div>
      </div>
    </div>
